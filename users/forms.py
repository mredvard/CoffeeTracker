...
class UserCreationForm(forms.ModelForm):
    ...
    password1 = forms.CharField(
        ...
        help_text='(6-16 char. Case sensitive)')
    ...
    def clean_password1(self):
        ...
        if password_length < 6 or password_length > 16:
            raise forms.ValidationError(
                'Your password has to be between 6 and 16 characters long'
            )
        return password1
...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'primary_phone', 'other_phone', 'fax', 'company_name',
